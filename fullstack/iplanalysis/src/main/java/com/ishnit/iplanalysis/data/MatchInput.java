...
public class MatchInput {
    ...
    public MatchInput(String id, String city, String date, String player_of_match, String venue,
            String neutral_venue, String team1, String team2, String toss_winner, String toss_decision, String winner,
            String result, String result_margin, String eliminator, String method, String umpire1, String umpire2) {
        this.id = id;
        this.city = city;
        this.date = date;
    ...
    public String toString() {
        return "InputMatchData [city=" + city + ", date=" + date + ", eliminator=" + eliminator + ", id=" + id
                + ", method=" + method + ", neutral_venue=" + neutral_venue + ", player_of_match=" + player_of_match
                + ", result=" + result + ", result_margin=" + result_margin + ", team1=" + team1 + ", team2=" + team2
